...
public static class DependencyContainer
{
  ...
  )
  {
    ...
    // Registrar el nuevo interfaz admin para CRUD de Customers y Products
    services.AddScoped<INorthWindSalesAdminDataContext, NorthWindSalesCommandsDataContext>();
    services.AddScoped<INorthWindDomainLogsDataContext,
        NorthWindDomainLogsDataContext>();
    // Register queries context for domain logs
    services.AddScoped<INorthWindDomainLogsQueriesDataContext, NorthWindDomainLogsQueriesDataContext>();
        return services;
  }
}
