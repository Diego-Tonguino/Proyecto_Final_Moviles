...
using NorthWind.Sales.Backend.Controllers.Admin;
using NorthWind.Sales.Backend.Controllers.Auth;
...
public static class EndpointsContainer
{
  ...
  public static WebApplication MapNorthWindSalesEndpoints(this WebApplication app)
  {
    ...
    app.UseCreateOrderController();
        ...
        // Registrar endpoints Auth, CRUD para Customers y Products
        app.UseAuthController();
        app.UseUsersController();
        app.UseCustomersController();
        app.UseProductsController();
        // Registrar endpoints para listar órdenes
        app.UseOrdersController();
        // Registrar endpoint para listar logs
        app.UseDomainLogsController();
